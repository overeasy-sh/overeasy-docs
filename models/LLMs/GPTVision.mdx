...
## Initialization:
- api_key: Optional. Your OpenAI API key. If not provided, it will attempt to use the OPENAI_API_KEY environment variable.
model: The model name, default is "gpt-4o". It should be one of the models that support image inputs.
...
image = Image.open("./ima_cardholder.jpg")

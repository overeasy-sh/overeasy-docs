---
title: 'Overview'
description: 'We will construct Workflows designed to enforce safety equipment compliance in construction areas. Specifically, we will analyze an image to detect people and determine if they are wearing hardhats.'
---

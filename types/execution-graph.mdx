...
## Execution Graph */}
An Execution Graph tracks the relationships between different [Execution Node](https://docs.overeasy.sh/types/about-execution-node) instances, representing the entire workflow's execution. Let's take a look at one step in a workflow: 
